...
df = pd.read_csv("C:/Users/noturno/Desktop/Neemias/Python 2/Sistema/drinks.csv")
...
# rota inicial com linkspara os gráficos
@app.route('/')
def index():
...
# Média do consumo por tipo global
@app.route('/grafico2')
def grafico2():
    conn = sqlite3.connect("C:/Users/noturno/Desktop/Neemias/Python 2/Sistema/04_consumo_alcool.db")
...
def grafico3():
    ...
    regioes = {
        ...
        "Asia": ["China", "Japan", "India", "Thayland"],
...
def grafico4():
    ...
    fig = px.pie(medias, names="Tipo", values="Media", title="Média de Consumo por Tipo de bebida")
    return fig.to_html() + '<br><a href="/">voltar ao inicio</a>'
...
def comparar():
    ...
    if request.method == "POST":
        ...
        conn = sqlite3.conecct("C:/Users/noturno/Desktop/Neemias/Python 2/Sistema/04_consumo_alcool.db")
    ...
    return render_template_string('''
        ...
        <form method="POST">
            ...
            <imput type="submit" value="comparar - ">                    
        </form>
''', opcoes=opcoes)
